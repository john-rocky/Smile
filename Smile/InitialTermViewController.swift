...
class InitialTermViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        AgreeButton.setTitle(NSLocalizedString("利用規約に同意してアプリを利用する", comment: ""), for: UIControl.State.normal)
        
        TitleLabel.text = NSLocalizedString("利用規約", comment: "")
        StatementLabel.text = NSLocalizedString("下記利用規約に同意いただいてからご利用ください。", comment: "")
    ...
    */
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.HeadLabel.text = NSLocalizedString(dataSouce[indexPath.item].0, comment: "")
        cell.TextLabel.text = NSLocalizedString(dataSouce[indexPath.item].1, comment: "")
